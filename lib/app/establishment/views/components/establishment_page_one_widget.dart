    ...
    return Container(
      ...
      child: Container(
          ...
          child: StreamBuilder<RoomState>(
              stream: context.read<RoomBloc>().stream,
              builder: (context, AsyncSnapshot<RoomState> snapshot) {
                if (!snapshot.hasData) {
                  return Center(
                  ...
                  if (state is SuccessRoomsState) {
                    ...
                    return RefreshIndicator(
                        ...
                        child: ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount:
                                context.read<RoomViewModel>().rooms.length,
